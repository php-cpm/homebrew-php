...
class XdebugOsx < Formula
  ...
  depends_on "php56-xdebug" if Formula["php@56"].linked_keg.exist?
  depends_on "php70-xdebug" if Formula["php@70"].linked_keg.exist?
  depends_on "php71-xdebug" if Formula["php@71"].linked_keg.exist?
  depends_on "php72-xdebug" if Formula["php@72"].linked_keg.exist?
